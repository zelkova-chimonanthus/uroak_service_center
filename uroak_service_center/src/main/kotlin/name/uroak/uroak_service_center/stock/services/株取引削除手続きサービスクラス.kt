...
import name.uroak.uroak_service_center.stock.repository.データ削除リポジトリ
 ...
 */
@Service
class 株取引削除手続きサービスクラス : 手続きサービスクラス {

    /***/
    @Autowired
    private lateinit var データ削除リポジトリ: データ削除リポジトリ

    /**
     *
     */
    constructor() : super("株取引削除手続きサービス") {
